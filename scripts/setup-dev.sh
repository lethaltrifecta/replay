...
echo "   2. Run migrations: go run cmd/cmdr/main.go migrate (when implemented)"
echo "   3. Start CMDR service: make run"
echo "   4. Run tests: make test"
echo ""
echo "🔗 Service URLs:"
echo "   - CMDR API:       http://localhost:8080"
echo "   - OTLP gRPC:      localhost:4317"
echo "   - OTLP HTTP:      localhost:4318"
echo "   - Jaeger UI:      http://localhost:16686"
echo "   - PostgreSQL:     localhost:5432"
echo "   - Freeze-Tools:   localhost:9090"
echo ""
echo "📚 Documentation:"
echo "   - README.md"
echo "   - DRAFT_PLAN2.md"
