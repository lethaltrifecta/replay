					...
					map[string]any{
						"spans": []any{
							...
							map[string]any{
								...
								"kind":              1,
								"startTimeUnixNano": fmt.Sprintf("%d", start),
								"endTimeUnixNano":   fmt.Sprintf("%d", start+5_000_000),
								"attributes": []any{
									map[string]any{"key": "gen_ai.operation.name", "value": map[string]any{"stringValue": "execute_tool"}},
									map[string]any{"key": "gen_ai.tool.name", "value": map[string]any{"stringValue": "calculator"}},
									map[string]any{"key": "gen_ai.tool.call.arguments", "value": map[string]any{"stringValue": `{"operation":"add","a":2,"b":2}`}},
									map[string]any{"key": "gen_ai.tool.call.result", "value": map[string]any{"stringValue": `{"result":4}`}},
								},
								"status": map[string]any{"code": 1},
							},
						},
